...
# Fonction pour filtrer les textes basés sur la langue, acceptant uniquement l'anglais et le français, parceque j'avais du russe sorti de nul part
...
# Convertir le JSON en DataFrame pour la manipulation
...
# Fusionne le DataFrame original avec les nouvelles colonnes one-hot
...
#DataFrame pour les avis avec les données du jeu associées
...
# Supprimer les colonnes inutiles des avis
columns_to_drop = [
