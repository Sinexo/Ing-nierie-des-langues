...
columns_to_drop = [
    ...
    'author.playtime_last_two_weeks', 'author.playtime_at_review', 'author.last_played', 'author.steamid','comment_count','timestamp_dev_responded','developer_response','languages'
]
